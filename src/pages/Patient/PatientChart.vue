  ...
  setup() {
    ...
    const updateCart = async () => {
      swalConfirmation(
        ...
        if (res.isConfirmed) {
          savingFlag.value = true;
          store.dispatch("updatePastHistory", pastHistory.value);
          store.dispatch("updateFamilyHistory", familyHistory.value);
          store.dispatch("updateFamilyHistory", socialHistory.value);
          store.dispatch("updatePatient", patient.value);
          store.dispatch("updateConsultation", consultation.value);
          store.dispatch("updateVitalSigns", consultation.value);
          resetter();
          swalMessage(
            swal,
            "Information",
