<template>
  <div class="row">
    <div class="col-12">
      <nav
        id="navbar-example2"
        class="navbar bg-body-tertiary px-3 mb-3 position-fixed"
      >
  ...
  <div class="row">
    <div class="col-lg-12 mb-4">
      ...
      <titled-card class="mt-5" title="Vital Signs">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div>
              <label class="form-label fs-6 mb-2 fw-semibold"
      ...
      <titled-card class="mt-5" title="Past History">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-6 col-lg-3">
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="form-check">
              <input
                ...
                false-value="0"
              />
              <label class="form-check-label" for="p-hyper">
                Hypertension
              </label>
            </div>
          </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="form-check">
              <input
                ...
                false-value="0"
              />
              <label class="form-check-label" for="p-pulmo">
                Pulmo Disease
              </label>
            </div>
          </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="form-check">
              <input
                ...
                false-value="0"
              />
              <label class="form-check-label" for="p-heart">
                Heart Disease
              </label>
            </div>
          </div>
      ...
      <titled-card class="mt-5" title="Family History">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="form-check">
              <input
          ...
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="form-check">
              <input
                ...
                false-value="0"
              />
              <label class="form-check-label" for="f-pulmo">
                Pulmo Disease
              </label>
            </div>
          </div>
      ...
      <titled-card class="mt-5" title="Social History">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-6 col-lg-3">
            <div>
      ...
      <titled-card class="mt-5" title="Vaccination">
        <div class="row mt-4">
      ...
      <titled-card class="mt-5" title="SOAP">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div>
      ...
      <titled-card class="mt-5" title="Consulting Physician">
        <div class="row mt-4">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div>
              <label class="form-label fs-5 mb-2 fw-semibold"
