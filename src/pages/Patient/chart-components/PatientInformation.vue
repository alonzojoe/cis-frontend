            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div>
                    ...
                    <input type="text" class="form-control form-control-sm custom-font"
                        v-model="consultation.consultation_no" disabled />
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div>
        ...
        <div class="row mt-3">
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div>
                    ...
                    <input type="date" :max="currentDate" class="form-control form-control-sm custom-font"
            ...
            <div class="col-sm-12 col-md-6 col-lg-3">
                <div>
                    ...
                    <input type="text" class="form-control form-control-sm custom-font" maxlength="11"
        ...
        <div class="row mt-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div>
                    ...
                    <Textarea v-model="consultation.chief_complaint" class="form-control form-control-sm custom-font"
