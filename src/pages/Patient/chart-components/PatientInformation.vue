    ...
    <div class="row mt-3">
      ...
      <div class="col-sm-12 col-md-6 col-lg-3">
        <div>
          ...
          <input type="text" class="form-control form-control-sm custom-font cst-capital" maxlength="5"
    ...
    <div class="row mt-3">
      <div class="col-sm-12 col-md-6 col-lg-6">
        <div>
          ...
          <Textarea v-model="patient.address" class="form-control form-control-sm custom-font cst-capital" autoResize
            rows="5" cols="30" />
        </div>
      </div>
      <div class="col-sm-12 col-md-6 col-lg-6">
