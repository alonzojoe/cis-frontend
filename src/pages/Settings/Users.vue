<template>
    <div class="card">
            ...
            <table class="table table-bordered table-hover">
                <thead>
                    <tr style="text-transform:capitalize !important;">
                        <th class="text-center bg-primary text-white fw-bold p-1 m-0">Email</th>
                        <th class="text-center bg-primary text-white fw-bold p-1 m-0">User</th>
        ...
        <paginator v-if="!isLoading && users.length" :data="paginationData"
